...
meanDat <- read.csv("/Users/jacksonanderson/Desktop/EBIO4420/compBioSandbox/CompBio_on_git/Labs/Lab07/DataForLab07.csv")
str(meanDat)
...
sumSqFunc(meanDat$x)#checking the sumSqFunc 
